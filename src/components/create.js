    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error('Error al crear la carta');
            }
        } catch (error) {
                    ...
                    <Col md={6} lg={8}>
                        <Card className='cardCreate'>
                            ...
                            <Card.Body>
                                ...
                                {showTitleAlert && (
                                    <Alert variant="danger" onClose={() => setShowTitleAlert(false)} dismissible>
                                        El título es obligatorio.
                                    </Alert>
                                )}
                                {showTextAlert && (
                                    <Alert variant="danger" onClose={() => setShowTextAlert(false)} dismissible>
                                        El texto es obligatorio.
                                    </Alert>
                                )}
                                {showImageAlert && (
                                    <Alert variant="danger" onClose={() => setShowImageAlert(false)} dismissible>
