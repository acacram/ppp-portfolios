...
import { faPenSquare, faTrash, faLock, faEye } from '@fortawesome/free-solid-svg-icons';
...
const UserDashboard = () => {
  ...
  Notas Públicas{" "}
  <FontAwesomeIcon icon={faEye} className="edit-icon me-2" size="1x" />
</h3>
                ...
                {cards.map((card, index) => (
                  card.visible === true && (
                    <Col key={index} className="d-flex justify-content-center align-items-center">
                      <Card className="full-card border-0 rounded-3 px-3 py-2" style={{ width: "100px" }}>
                        <img
                          className="card-image rounded-3"
                          src={card.image}
                          alt=""
                        />
                        <h6 className="mt-2 overflow-ellipsis">{card.title}</h6>
                        ...
                        <div className="d-flex justify-content-between mt-2">
                          <FontAwesomeIcon icon={faPenSquare} className="edit-icon me-1" size="1x" />
            ...
            <Col className="bg-dark" xs={12} lg={6}>
              <h3 className="titulonota">Notas Privadas{" "}
                <FontAwesomeIcon icon={faLock} className="edit-icon me-2" size="1x" />
              </h3>
              <Row xs={3} className="g-4">
                {cards.map((card, index) => (
                  card.visible === false && (
